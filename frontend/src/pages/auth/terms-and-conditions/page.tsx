            ...
            <Box className="flex flex-col gap-10">
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-primary">
                  Welcome to pantryOS! These terms and conditions outline the rules and regulations for the use of pantryOS.dev.
                  By accessing this website we assume you accept these terms and conditions. Do not continue to use
                  pantryOS.dev if you do not agree to all of the terms and conditions stated on this page.
                </Typography>
              </Box>
              ...
              <Box>
                ...
                <Typography variant="body1">
                  Other than the content you own, under these Terms, pantryOS and/or its licensors own all the intellectual
                ...
                <Typography variant="body1">
                  This Website is provided “as is,” with all faults, and pantryOS expresses no representations or
                  warranties.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  In no event shall pantryOS, nor any of its officers, directors and employees, be held liable for anything
                ...
                <Typography variant="body1">
                  You hereby indemnify to the fullest extent pantryOS from and against any and all liabilities, costs,
                ...
                <Typography variant="body1">
                  pantryOS is permitted to revise these Terms at any time as it sees fit.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  These Terms constitute the entire agreement between pantryOS and you.
                </Typography>
                <br />
